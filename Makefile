...
SRCS		:= src/utils/delete_content.c src/utils/delete_content2.c src/utils/error_handler.c src/utils/handle_signal.c src/utils/safe_func.c src/utils/wrapper.c src/utils/wrapper_str.c src/heredoc/expander_heredoc.c src/heredoc/set_heredoc.c src/env/get_env_value.c src/env/get_environ.c src/env/init_envlist.c src/env/init_sh_var.c src/env/set_env_value.c src/env/sort_env_list.c src/expander/convert_to_token_list.c src/expander/expand_token.c src/expander/expand_wildcard.c src/expander/expander.c src/expander/extract_word.c src/expander/match_files.c src/expander/match_pattern.c src/executor/exec_builtin.c src/executor/exec_child.c src/executor/exec_processes.c src/executor/exec_single_process.c src/executor/executor.c src/executor/get_fullpath_cmd.c src/executor/handle_fd.c src/executor/set_io_and_commands.c src/executor/set_io_params.c src/main/main.c src/builtin/builtin_cd.c src/builtin/builtin_cd2.c src/builtin/builtin_echo.c src/builtin/builtin_env.c src/builtin/builtin_exit.c src/builtin/builtin_export.c src/builtin/builtin_pwd.c src/builtin/builtin_unset.c src/analyzer/convert_to_expression_tree.c src/analyzer/lexer.c src/analyzer/node_utils.c src/analyzer/parser.c src/analyzer/validate_line.c
