...
TEST(lexer, lexer_test02)
{
	...
	t_token_kind expected_kind[] = {TK_STRING, TK_STRING, TK_RESERVED, TK_STRING, TK_STRING, TK_RESERVED, TK_STRING, TK_STRING};
...
TEST(lexer, lexer_test03)
{
	...
	t_token_kind expected_kind[] = {TK_STRING, TK_STRING, TK_RESERVED, TK_STRING};
...
TEST(lexer, lexer_test04)
{
	...
	t_token_kind expected_kind[] = {TK_STRING, TK_STRING, TK_RESERVED, TK_STRING, TK_STRING};
...
TEST(lexer, lexer_test07)
{
	...
	t_token_kind expected_kind[] = {TK_STRING, TK_RESERVED, TK_STRING, TK_REDIRECT, TK_STRING};
...
TEST(lexer, lexer_test08)
{
	char *input = "ls;cat>file.txt;";
	char	*expected[] = {"ls", ";", "cat", ">", "file.txt", ";"};
	t_token_kind expected_kind[] = {TK_STRING, TK_RESERVED, TK_STRING, TK_REDIRECT, TK_STRING, TK_RESERVED};
